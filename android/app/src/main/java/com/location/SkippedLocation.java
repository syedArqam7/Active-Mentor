...
public class SkippedLocation extends DetectionLocation {

    //todo how should we handle this class.
    public SkippedLocation(int frameID, String classlabel) {
        super(classlabel, 0, 0, frameID, 0, STATUS.SKIPPED);
        process();
    }
