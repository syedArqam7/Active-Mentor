...
@objc protocol CameraFeedManagerDelegatePE: class {
  /// This method delivers the pixel buffer of the current frame seen by the device's camera.
  @objc optional func cameraFeedManager(
    _ manager: CameraFeedManagerPE, didOutput pixelBuffer: CVPixelBuffer
  )
...
class CameraFeedManagerPE: NSObject {
  ...
  weak var delegate: CameraFeedManagerDelegatePE?
...
extension CameraFeedManagerPE: AVCaptureVideoDataOutputSampleBufferDelegate {
