...
class TensorFlowObjectDetection: UIViewController {
...
extension TensorFlowObjectDetection: InferenceViewControllerDelegate {
...
extension TensorFlowObjectDetection: CameraFeedManagerDelegate {
...
extension TensorFlowObjectDetection {
  ...
  private func addPanGesture() {
    let panGesture = UIPanGestureRecognizer(target: self, action: #selector(TensorFlowObjectDetection.didPan(panGesture:)))
